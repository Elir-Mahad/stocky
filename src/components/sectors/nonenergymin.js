...
class Nonenergymins extends React.Component {
    ...
    componentDidMount() {
        ...
        // non energy minerals stocks 

            const url = "https://sandbox.iexapis.com/stable/stock/market/collection/tag?collectionName=Non-Energy Minerals&token="+apikey
