...
class Electrocomponent extends React.Component {
    ...
    componentDidMount() {
        ...
        const url = "https://sandbox.iexapis.com/stable/stock/market/collection/tag?collectionName=Electronic Components&token="+apikey
