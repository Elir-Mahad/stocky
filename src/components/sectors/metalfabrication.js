...
class Metalfabrication extends React.Component {
    ...
    componentDidMount() {
        ...
        const url = "https://sandbox.iexapis.com/stable/stock/market/collection/tag?collectionName=Metal Fabrication&token="+apikey
