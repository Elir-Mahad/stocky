...
class Dataprocessing extends React.Component {
    ...
    componentDidMount() {
        ...
        // Data Processing Services stocks

        const url = "https://sandbox.iexapis.com/stable/stock/market/collection/tag?collectionName=Data Processing Services&token="+apikey
