...
class Industrialmachinery extends React.Component {
    ...
    componentDidMount() {
        ...
        const url = "https://sandbox.iexapis.com/stable/stock/market/collection/tag?collectionName=Industrial Machinery&token="+apikey
